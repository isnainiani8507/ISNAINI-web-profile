      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" style="padding-top: 80px;">
          <div class="col-md-8 ftco-animate text-center">
            <h1 class="mb-3 bread" style="color: white; font-weight: 700;">My Skills</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="/#home-section" style="color: rgba(255,255,255,0.8);">Home <i class="fa fa-chevron-right"></i></a></span> <span style="color: rgba(255,255,255,0.5);">Skills <i class="fa fa-chevron-right"></i></span></p>
          </div>
        </div>
      </div>
    </section>
