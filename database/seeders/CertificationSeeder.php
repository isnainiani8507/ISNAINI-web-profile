...
class CertificationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \Illuminate\Support\Facades\DB::table('certifications')->insert([
            ...
            'pdf' => 'Sertifikat TDA - Mengelola Keuangan.pdf'],
            ...
            'pdf' => 'Seminar Nasional - Peran Media Kreatif otomotif & Informasi.pdf'],
            ...
            'pdf' => 'SERTIFIKAT PANITIA Pelatihan Public Speaking Character Building - Isnaini Fathul Jannah.pdf'],
            ...
            'pdf' => 'Sertifikat Seminar AI For Your Coding Assitant - ISNAINI FATHUL J..pdf'],
        ]);
    }
}
